package bg.softuni.forum.web.filter;
...
public class AuthenticationFilter implements Filter, Serializable {
	...
	public static final String PATH_WELCOME = "/pages/welcome.html";
	public static final String PATH_LOGOUT = "/pages/logout.jsp";
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		 ...
		 */
		if (PATH_WELCOME.equals(requestedPath)) {
			chain.doFilter(request, response);
			return;
		}
		 ...
		 */
		if (loggedUser == null) {
			RequestDispatcher requestDispatcher = request.getRequestDispatcher(PATH_WELCOME);
